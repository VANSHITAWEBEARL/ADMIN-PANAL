    ...
    <header className="w-full fixed top-0 left-0 right-0 z-50 bg-[#23282d] px-3 py-2 shadow-lg text-sm">
      <div className="flex flex-wrap items-center justify-between">
        ...
        <nav className="mt-2 sm:mt-0 flex items-center">
          ...
          <Link to="/Profile" className="text-white no-underline font-medium flex items-center cursor-pointer gap-1">  <i className="fa-solid fa-user" aria-hidden="true"></i></Link>
          </span>
        </nav>
      </div>
    </header>
