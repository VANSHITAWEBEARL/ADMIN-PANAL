  ...
  const shopMenu = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Load More', to: '/Loadmore' },
        { label: 'Shop Masonry', to: '/Masonryshop' },
      ...
      <div className="mx-15 flex items-center justify-around py-2 px-4">
        ...
        <div className='flex '>
          <ul className='flex flex-row justify-between items-center gap-5'>
            ...
            >
              <Link to='/HOME' className="pb-1 !text-[#df574a] !no-underline border-b-2 border-transparent  group-hover:border-[#df574a] transition-all duration-200 inline-block">HOME</Link>
                        ...
                        item.to ? (
                          <li key={idx} className="border-b border-gray-200">
                            <Link to={item.to} className="flex items-center gap-2 text-md font-normal no-underline !text-gray-500 py-1 transition group" style={{ textDecoration: 'none' }}>
                              <span className="hover:text-[#df574a] transition-colors">{item.label}</span>
                              {item.highlight && (
                                <span
                                  className="ml-1 text-xs font-normal bg-gray-100 px-1 transition-colors hover:text-[#df574a]"
            ...
            >
              <span className="pb-1 border-b-2 border-transparent hover:text-[#df574a] hover:border-[#df574a] transition-all duration-200 inline-block">SHOP</span>

              {showShopDropdown && (
                <div className="absolute top-full -left-60 max-w-7xl w-220 bg-white shadow-2xl z-50 p-4 flex flex-row gap-5" style={{ borderTop: '2px solid #df574a' }}>
                  {shopMenu.map((menu, i) => (
                    <div key={i}>
                      ...
                      <ul className='p-0 flex gap-3 flex-col'>
                        {menu.items.map((item, idx) => (
                          <li key={idx}>
                            <Link
                              to={item.to}
                              className="!text-gray-500 font-normal gap-2 flex border-b border-gray-100 !hover:text-[#7ad03a] font p-0 !no-underline transition"
                            >
                              {item.label}
                            </Link>
                          </li>
            ...
            >
              <span className="pb-1 border-b-2 border-transparent group-hover:border-[#df574a] transition-all duration-200 inline-block">BLOG</span>
            ...
            >
              <span className="pb-1 border-b-2 border-transparent group-hover:border-[#df574a] transition-all duration-200 inline-block">PAGES</span>
            ...
            >
              <span className="pb-1 border-b-2 border-transparent group-hover:border-[#df574a] transition-all duration-200 inline-block">PORTFOLIOS</span>
            ...
            >
              <span className="pb-1 border-b-2 border-transparent group-hover:border-[#df574a] transition-all duration-200 inline-block">ELEMENTS</span>
