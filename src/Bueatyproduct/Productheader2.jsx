...
const Productheader2 = () => {
  ...
  const dropdownLinkClass =
    "flex items-center gap-2 text-md font-normal text-gray-500 !no-underline py-1 !hover:text-[#7ad03a] transition";
      ...
      <div className="mx-15 flex items-center justify-between py-2 px-4">
        ...
        <div className='flex '>
          <ul className='flex flex-row justify-between items-center gap-5'>
            ...
            >
              <Link to='/HOME' className="pb-1 !text-[#7ad03a] !no-underline border-b-2 border-transparent  group-hover:border-[#7ad03a] transition-all duration-200 inline-block">HOME</Link>
                        ...
                        item.to ? (
                          <li key={idx} className="border-b border-gray-200">
                            <Link to={item.to} className="flex items-center gap-2 text-md font-normal no-underline !text-gray-500 py-1 transition group" style={{ textDecoration: 'none' }}>
                              <span className="hover:text-[#7ad03a] transition-colors">{item.label}</span>
                              {item.highlight && (
                                <span
                                  className="ml-1 text-xs font-normal bg-gray-100 px-1 transition-colors hover:text-[#7ad03a]"
            ...
            >
              <span className="pb-1 border-b-2 border-transparent hover:text-[#7ad03a] hover:border-ansition-all duration-200 inline-block">SHOP</span>

             
                  {showShopDropdown && (
                    <div className="absolute top-full -left-30 max-w-7xl w-220 bg-white shadow-2xl z-50 p-4 flex flex-row gap-5" style={{ borderTop: '2px solid #7ad03a' }}>
                      {shopMenu.map((menu, i) => (
                        <div key={i}>
