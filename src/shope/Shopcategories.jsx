...
import img1 from "../assets/26-1.jpg"
import img2 from "../assets/26-2.jpg"
import img3 from "../assets/26-3.jpg"
import img4 from "../assets/26-4.jpg"
import img5 from "../assets/26-5.jpg"
import img6 from "../assets/26-6.jpg"
import img7 from "../assets/26-7.jpg"
import img8 from "../assets/26-8.jpg"
import img9 from "../assets/26-9.jpg"
import img10 from "../assets/26-10.jpg"
import img11 from "../assets/26-11.jpg"
import img12 from "../assets/26-12.jpg"
        ...
        <div>
            ...
            <div className="relative -z-12 bg-cover bg-position-[center_left_-15rem] h-95 py-20"
                ...
                <div class="relative z-10 text-center text-white max-w-5xl mx-auto">
                    {/* <!-- Title & Breadcrumb --> */}
                    <h1 className="!text-3xl font-bold capitalize text-center capitalize" style={{ fontFamily: 'Playfair Display' }}>
                        Totes & Hobo
                    </h1>

                    <div className="mt-2 text-lg flex items-center justify-center gap-1">
            ...
            <div className="flex max-w-7xl mx-auto py-10 px-4 gap-8">
                ...
                <main className="flex flex-col gap-3">
                    <div className="w-240 border p-3 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className={`${viewMode === 'grid3' ? 'grid grid-cols-1 md:grid-cols-3 gap-3 justify-center items-center' :
                        viewMode === 'grid4' ? 'grid grid-cols-1 md:grid-cols-4 gap-3' :
                            'flex flex-col gap-6'
                        }  place-items-start`}>
                        {/* Product cards */}
                        {[img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, img11, img12].map((img, index) => (
                            <div key={index} className={`${viewMode === 'list' ?
                                'w-160 flex  md:flex-col gap-6 items-start p-6 border-b border-gray-100  transition-shadow duration-300' :
                                'w-full flex items-center justify-center flex-col transition-shadow duration-300'
                                }`}>
                                <img
                                    src={img}
                                    alt="Product"
                                    className={`${viewMode === 'list' ? 'h-60 w-60 object-contain' : 'h-60 w-auto object-contain'
                                        }`}
                                />
                                <div className={`${viewMode === 'list' ? 'text-left flex-1' : 'text-center'
                                    ...
                                    {viewMode === 'list' && (
                                        <>
                                            ...
                                            <p className="text-gray-600 w-140 text-[14px] font-medium  leading-[28px]   text-justify">
                                                Lorem ipsum dolor sit amet, feugiat delicata liberavisse id cum, no quo
                                                maiorum intellegebat, liber regione eu sit. Mea cu case ludus integre, vide
                                                viderer eleifend ex mea.
                                            </p>
                                        </>
                                    )}
                                </div>
